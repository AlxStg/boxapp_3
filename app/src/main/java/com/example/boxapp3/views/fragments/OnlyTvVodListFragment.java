...
public class OnlyTvVodListFragment extends Fragment {
    ...
    private OnlyTvActivityListener mainActivityListener;
    private String type;

    public OnlyTvVodListFragment(String type, OnlyTvActivityListener mainActivityListener) {
        this.type = type;
